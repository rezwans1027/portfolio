...
const About = () => {
  return (
    <div className='w-full bg-white px-16 py-12 flex items-center'>
      <div className='rounded-2xl bg-khaki mt-16 p-8 shadow-xl'>
        <h1 id='about' className='text-5xl p-4 text-white rounded-t-2xl'>
          About Me
        </h1>
